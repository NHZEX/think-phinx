 ...
 */
class TimedOutputAdapter extends \Phinx\Db\Adapter\AdapterWrapper implements \Phinx\Db\Adapter\DirectActionInterface
{
    /**
     * @inheritDoc
     */
    ...
    public function changePrimaryKey(Table $table, $newColumns) : void
    {
        ...
        if (!$adapter instanceof \Phinx\Db\Adapter\DirectActionInterface) {
