 ...
 */
class SQLiteAdapter extends \Phinx\Db\Adapter\PdoAdapter
{
...
PCRE_PATTERN;
        ...
        $defaultClean = \trim(\implode('', $matches));
    ...
    public function getSqlType($type, ?int $limit = null) : array
    {
        ...
        if ($type instanceof Literal) {
            ...
            throw new \Phinx\Db\Adapter\UnsupportedColumnTypeException('Column type "' . $type . '" is not supported by SQLite.');
        } else {
            throw new \Phinx\Db\Adapter\UnsupportedColumnTypeException('Column type "' . $type . '" is not known by SQLite.');
        }
