 ...
 */
abstract class AbstractAdapter implements \Phinx\Db\Adapter\AdapterInterface
{
    /**
    ...
    public function setOptions(array $options) : \Phinx\Db\Adapter\AdapterInterface
    {
        ...
        if (isset($options['default_migration_table'])) {
            \trigger_error('The default_migration_table setting for adapter has been deprecated since 0.13.0. Use `migration_table` instead.', \E_USER_DEPRECATED);
    ...
    public function createSchemaTable() : void
    {
        try {
            ...
            $table->addColumn('version', 'biginteger', ['null' => \false])->addColumn('migration_name', 'string', ['limit' => 100, 'default' => null, 'null' => \true])->addColumn('start_time', 'timestamp', ['default' => null, 'null' => \true])->addColumn('end_time', 'timestamp', ['default' => null, 'null' => \true])->addColumn('breakpoint', 'boolean', ['default' => \false, 'null' => \false])->save();
