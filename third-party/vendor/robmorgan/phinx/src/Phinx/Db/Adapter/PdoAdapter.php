 ...
 */
abstract class PdoAdapter extends \Phinx\Db\Adapter\AbstractAdapter implements \Phinx\Db\Adapter\DirectActionInterface
{
    /**
     * @var \PDO|null
     */
    ...
    protected function createPdoConnection(string $dsn, ?string $username = null, ?string $password = null, array $options = []) : PDO
    {
        ...
        try {
            ...
            throw new InvalidArgumentException(\sprintf('There was a problem connecting to the database: %s', $e->getMessage()), 0, $e);
        }
        return $db;
    }
    /**
     * @inheritDoc
     */
    public function setOptions(array $options) : \Phinx\Db\Adapter\AdapterInterface
    {
     ...
     */
    public function setConnection(PDO $connection) : \Phinx\Db\Adapter\AdapterInterface
    {
        ...
        if (!$this->hasTable($this->getSchemaTableName())) {
            ...
            if (!$table->hasColumn('breakpoint')) {
                $table->addColumn('breakpoint', 'boolean', ['default' => \false, 'null' => \false])->save();
            }
        }
        return $this;
    }
     ...
     * @inheritDoc
     */
    public function migrated(MigrationInterface $migration, string $direction, string $startTime, string $endTime) : \Phinx\Db\Adapter\AdapterInterface
    {
     ...
     * @inheritDoc
     */
    public function toggleBreakpoint(MigrationInterface $migration) : \Phinx\Db\Adapter\AdapterInterface
    {
     ...
     * @inheritDoc
     */
    public function setBreakpoint(MigrationInterface $migration) : \Phinx\Db\Adapter\AdapterInterface
    {
        $this->markBreakpoint($migration, \true);
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function unsetBreakpoint(MigrationInterface $migration) : \Phinx\Db\Adapter\AdapterInterface
    {
     ...
     * @return \Phinx\Db\Adapter\AdapterInterface
     */
    protected function markBreakpoint(MigrationInterface $migration, bool $state) : \Phinx\Db\Adapter\AdapterInterface
    {
     ...
     */
    protected abstract function getAddColumnInstructions(Table $table, Column $column) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getRenameColumnInstructions(string $tableName, string $columnName, string $newColumnName) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getChangeColumnInstructions(string $tableName, string $columnName, Column $newColumn) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropColumnInstructions(string $tableName, string $columnName) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getAddIndexInstructions(Table $table, Index $index) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropIndexByColumnsInstructions(string $tableName, $columns) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropIndexByNameInstructions(string $tableName, string $indexName) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getAddForeignKeyInstructions(Table $table, ForeignKey $foreignKey) : AlterInstructions;
    /**
     * @inheritDoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropForeignKeyInstructions(string $tableName, string $constraint) : AlterInstructions;
    /**
     * Returns the instructions to drop the specified foreign key from a database table.
     *
     * @param string $tableName The table where the foreign key constraint is
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropForeignKeyByColumnsInstructions(string $tableName, array $columns) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getDropTableInstructions(string $tableName) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getRenameTableInstructions(string $tableName, string $newTableName) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getChangePrimaryKeyInstructions(Table $table, $newColumns) : AlterInstructions;
    /**
     * @inheritdoc
     */
     ...
     * @return \Phinx\Db\Util\AlterInstructions
     */
    protected abstract function getChangeCommentInstructions(Table $table, ?string $newComment) : AlterInstructions;
    /**
     * {@inheritDoc}
     *
