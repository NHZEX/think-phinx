 ...
 */
class SqlServerAdapter extends \Phinx\Db\Adapter\PdoAdapter
{
    /**
     * @var string[]
     */
    ...
    protected function connectDblib() : void
    {
        ...
        try {
            ...
            throw new InvalidArgumentException(\sprintf('There was a problem connecting to the database: %s', $exception->getMessage()), 0, $exception);
        }
        $this->setConnection($db);
    }
    /**
    ...
    public function getColumns(string $tableName) : array
    {
        ...
        foreach ($rows as $columnInfo) {
            ...
            } catch (\Phinx\Db\Adapter\UnsupportedColumnTypeException $e) {
...
SQL;
    ...
    public function getSqlType($type, ?int $limit = null) : array
    {
        switch ($type) {
            ...
            default:
                throw new \Phinx\Db\Adapter\UnsupportedColumnTypeException('Column type "' . $type . '" is not supported by SqlServer.');
        }
    }
    /**
    ...
    public function getPhinxType(string $sqlType) : string
    {
        switch ($sqlType) {
            ...
            default:
                throw new \Phinx\Db\Adapter\UnsupportedColumnTypeException('Column type "' . $sqlType . '" is not supported by SqlServer.');
        }
    }
    /**
     * @inheritDoc
...
SQL;
     ...
     * @return string
     */
    protected function getColumnSqlDefinition(Column $column, bool $create = \true) : string
    {
        $buffer = [];
