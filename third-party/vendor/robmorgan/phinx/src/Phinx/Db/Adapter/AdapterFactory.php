...
class AdapterFactory
{
     ...
     */
    protected $adapters = ['mysql' => 'Phinx\\Db\\Adapter\\MysqlAdapter', 'pgsql' => 'Phinx\\Db\\Adapter\\PostgresAdapter', 'sqlite' => 'Phinx\\Db\\Adapter\\SQLiteAdapter', 'sqlsrv' => 'Phinx\\Db\\Adapter\\SqlServerAdapter'];
    /**
     * Class map of adapters wrappers, indexed by name.
     *
     * @var array<string, \Phinx\Db\Adapter\WrapperInterface|string>
     */
    protected $wrappers = ['prefix' => 'Phinx\\Db\\Adapter\\TablePrefixAdapter', 'proxy' => 'Phinx\\Db\\Adapter\\ProxyAdapter', 'timed' => 'Phinx\\Db\\Adapter\\TimedOutputAdapter'];
    /**
    ...
    public function registerAdapter(string $name, $class)
    {
        if (!\is_subclass_of($class, 'Phinx\\Db\\Adapter\\AdapterInterface')) {
            throw new RuntimeException(\sprintf('Adapter class "%s" must implement Phinx\\Db\\Adapter\\AdapterInterface', \is_string($class) ? $class : \get_class($class)));
        }
     ...
     */
    public function getAdapter(string $name, array $options) : \Phinx\Db\Adapter\AdapterInterface
    {
    ...
    public function registerWrapper(string $name, $class)
    {
        if (!\is_subclass_of($class, 'Phinx\\Db\\Adapter\\WrapperInterface')) {
            throw new RuntimeException(\sprintf('Wrapper class "%s" must be implement Phinx\\Db\\Adapter\\WrapperInterface', \is_string($class) ? $class : \get_class($class)));
        }
     ...
     */
    public function getWrapper(string $name, \Phinx\Db\Adapter\AdapterInterface $adapter) : \Phinx\Db\Adapter\AdapterWrapper
    {
