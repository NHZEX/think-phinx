 ...
 */
abstract class AbstractMigration implements \Phinx\Migration\MigrationInterface
{
    /**
     * @var string
     */
     ...
     */
    public final function __construct(string $environment, int $version, ?InputInterface $input = null, ?OutputInterface $output = null)
    {
     ...
     * @inheritDoc
     */
    public function setAdapter(AdapterInterface $adapter) : \Phinx\Migration\MigrationInterface
    {
     ...
     * @inheritDoc
     */
    public function setInput(InputInterface $input) : \Phinx\Migration\MigrationInterface
    {
        $this->input = $input;
        return $this;
    }
     ...
     * @inheritDoc
     */
    public function setOutput(OutputInterface $output) : \Phinx\Migration\MigrationInterface
    {
        $this->output = $output;
        return $this;
    }
     ...
     * @inheritDoc
     */
    public function setVersion($version) : \Phinx\Migration\MigrationInterface
    {
        $this->version = $version;
        return $this;
    }
     ...
     * @inheritDoc
     */
    public function setMigratingUp(bool $isMigratingUp) : \Phinx\Migration\MigrationInterface
    {
    ...
    {
        if (\method_exists($this, \Phinx\Migration\MigrationInterface::CHANGE)) {
            if (\method_exists($this, \Phinx\Migration\MigrationInterface::UP) || \method_exists($this, \Phinx\Migration\MigrationInterface::DOWN)) {
                $this->output->writeln(\sprintf('<comment>warning</comment> Migration contains both change() and up()/down() methods.  <options=bold>Ignoring up() and down()</>.'));
            }
        }
    }
    /**
