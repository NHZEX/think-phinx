 ...
 * @author Rob Morgan
 */
class Config implements \Phinx\Config\ConfigInterface, \Phinx\Config\NamespaceAwareInterface
{
    ...
    public function __construct(array $configArray, ?string $configFilePath = null)
    {
        ...
        if (isset($this->values['feature_flags'])) {
            \Phinx\Config\FeatureFlags::setFlagsFromConfig($this->values['feature_flags']);
        }
    }
    /**
     ...
     */
    public static function fromYaml(string $configFilePath) : \Phinx\Config\ConfigInterface
    {
        if (!\class_exists('Symfony\\Component\\Yaml\\Yaml', \true)) {
     ...
     * @return \Phinx\Config\ConfigInterface
     */
    public static function fromJson(string $configFilePath) : \Phinx\Config\ConfigInterface
    {
     ...
     * @return \Phinx\Config\ConfigInterface
     */
    public static function fromPhp(string $configFilePath) : \Phinx\Config\ConfigInterface
    {
        \ob_start();
    ...
    public function getEnvironment(string $name) : ?array
    {
        ...
        if (isset($environments[$name])) {
            if (isset($this->values['environments']['default_migration_table']) && !isset($environments[$name]['migration_table'])) {
                $environments[$name]['migration_table'] = $this->values['environments']['default_migration_table'];
            }
    ...
    public function getDefaultEnvironment() : string
    {
        ...
        if (isset($this->values['environments']['default_database'])) {
            \trigger_error('default_database in the config has been deprecated since 0.12, use default_environment instead.', \E_USER_DEPRECATED);
     ...
     * @inheritdoc
     */
    public function getMigrationBaseClassName(bool $dropNamespace = \true) : string
    {
     ...
     * @inheritdoc
     */
    public function getSeedBaseClassName(bool $dropNamespace = \true) : string
    {
