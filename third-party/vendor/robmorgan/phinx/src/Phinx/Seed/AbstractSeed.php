 ...
 */
abstract class AbstractSeed implements \Phinx\Seed\SeedInterface
{
    /**
     * @var string
     */
     ...
     * @inheritDoc
     */
    public function setAdapter(AdapterInterface $adapter) : \Phinx\Seed\SeedInterface
    {
     ...
     * @inheritDoc
     */
    public function setOutput(OutputInterface $output) : \Phinx\Seed\SeedInterface
    {
        $this->output = $output;
        return $this;
    }
