...
use _Z_PhinxVendor\Cake\Database\Schema\SqliteSchemaDialect;
use _Z_PhinxVendor\Cake\Database\SqliteCompiler;
use _Z_PhinxVendor\Cake\Database\Statement\PDOStatement;
use _Z_PhinxVendor\Cake\Database\Statement\SqliteStatement;
