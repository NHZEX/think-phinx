...
use _Z_PhinxVendor\Cake\Database\Expression\StringExpression;
use _Z_PhinxVendor\Cake\Database\PostgresCompiler;
use _Z_PhinxVendor\Cake\Database\Query;
use _Z_PhinxVendor\Cake\Database\QueryCompiler;
use _Z_PhinxVendor\Cake\Database\Schema\PostgresSchemaDialect;
...
class Postgres extends Driver
{
    ...
    protected function _transformIdentifierExpression(IdentifierExpression $expression) : void
    {
        ...
        if ($collation) {
            ...
            $expression->setCollation('"' . \trim($collation, '"') . '"');
        }
    }
    /**
    ...
    {
        // use trim() to work around expression being transformed multiple times
        $expression->setCollation('"' . \trim($expression->getCollation(), '"') . '"');
    }
    /**
     * {@inheritDoc}
     *
