 ...
 */
namespace _Z_PhinxVendor\Cake\Database\Driver;

use _Z_PhinxVendor\Cake\Database\Driver;
...
use _Z_PhinxVendor\Cake\Database\Expression\OrderClauseExpression;
use _Z_PhinxVendor\Cake\Database\Expression\TupleComparison;
use _Z_PhinxVendor\Cake\Database\Expression\UnaryExpression;
use _Z_PhinxVendor\Cake\Database\ExpressionInterface;
use _Z_PhinxVendor\Cake\Database\Query;
use _Z_PhinxVendor\Cake\Database\QueryCompiler;
use _Z_PhinxVendor\Cake\Database\Schema\SchemaDialect;
use _Z_PhinxVendor\Cake\Database\Schema\SqlserverSchemaDialect;
use _Z_PhinxVendor\Cake\Database\SqlserverCompiler;
use _Z_PhinxVendor\Cake\Database\Statement\SqlserverStatement;
...
class Sqlserver extends Driver
{
    ...
    protected $_baseConfig = [
        'host' => '_Z_PhinxVendor\\localhost\\SQLEXPRESS',
        'username' => '',
        'password' => '',
        'database' => 'cake',
        'port' => '',
