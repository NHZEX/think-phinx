...
use _Z_PhinxVendor\Cake\Database\Retry\ErrorCodeWaitStrategy;
use _Z_PhinxVendor\Cake\Database\Schema\SchemaDialect;
use _Z_PhinxVendor\Cake\Database\Schema\TableSchema;
use _Z_PhinxVendor\Cake\Database\Statement\PDOStatement;
use Closure;
...
abstract class Driver implements DriverInterface
{
     ...
     * @inheritDoc
     */
    public abstract function enabled() : bool;
    /**
     * @inheritDoc
     */
     ...
     * @inheritDoc
     */
    public abstract function queryTranslator(string $type) : Closure;
    /**
     * @inheritDoc
     */
    public abstract function schemaDialect() : SchemaDialect;
    /**
     * @inheritDoc
     */
