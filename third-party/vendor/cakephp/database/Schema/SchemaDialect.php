...
use _Z_PhinxVendor\Cake\Database\Type\ColumnSchemaAwareInterface;
...
abstract class SchemaDialect
{
     ...
     */
    public abstract function listTablesSql(array $config) : array;
    /**
     ...
     * @return array An array of (sql, params) to execute.
     */
    public abstract function describeColumnSql(string $tableName, array $config) : array;
    /**
     ...
     * @return array An array of (sql, params) to execute.
     */
    public abstract function describeIndexSql(string $tableName, array $config) : array;
    /**
     ...
     * @return array An array of (sql, params) to execute.
     */
    public abstract function describeForeignKeySql(string $tableName, array $config) : array;
    /**
     ...
     * @return void
     */
    public abstract function convertColumnDescription(TableSchema $schema, array $row) : void;
    /**
     ...
     * @return void
     */
    public abstract function convertIndexDescription(TableSchema $schema, array $row) : void;
    /**
     ...
     * @return void
     */
    public abstract function convertForeignKeyDescription(TableSchema $schema, array $row) : void;
    /**
     ...
     */
    public abstract function createTableSql(TableSchema $schema, array $columns, array $constraints, array $indexes) : array;
    /**
     ...
     */
    public abstract function columnSql(TableSchema $schema, string $name) : string;
    /**
     ...
     */
    public abstract function addConstraintSql(TableSchema $schema) : array;
    /**
     ...
     * @return array SQL fragment.
     */
    public abstract function dropConstraintSql(TableSchema $schema) : array;
    /**
     ...
     * @return string SQL fragment.
     */
    public abstract function constraintSql(TableSchema $schema, string $name) : string;
    /**
     ...
     * @return string SQL fragment.
     */
    public abstract function indexSql(TableSchema $schema, string $name) : string;
    /**
