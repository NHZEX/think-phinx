 ...
 */
namespace _Z_PhinxVendor\Cake\Datasource\Paging;

use _Z_PhinxVendor\Cake\Core\Exception\CakeException;
use _Z_PhinxVendor\Cake\Core\InstanceConfigTrait;
use _Z_PhinxVendor\Cake\Datasource\Paging\Exception\PageOutOfBoundsException;
...
// phpcs:disable
\class_alias('_Z_PhinxVendor\\Cake\\Datasource\\Paging\\NumericPaginator', '_Z_PhinxVendor\\Cake\\Datasource\\Paginator');
// phpcs:enable
