...
use _Z_PhinxVendor\Cake\Console\CommandCollection;
use _Z_PhinxVendor\Cake\Event\EventDispatcherInterface;
use _Z_PhinxVendor\Cake\Http\MiddlewareQueue;
use _Z_PhinxVendor\Cake\Routing\RouteBuilder;
/**
